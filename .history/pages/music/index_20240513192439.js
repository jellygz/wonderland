...
export default function Music() {
    const allSongs = [
      ...
      const formatTime = (timeInSeconds) => {
        ...
        if( timeInSeconds ==undefined||timeInSeconds==Na){
          return "00:00"
        }
        ...
        return formatMinutes==NaN?"00:00": `${formatMinutes}:${formatSeconds}`;
      }
            ...
            <div className={styles.container}>
              ...
              <div className={styles.musicPlayerContainer}>
                <div className={styles.imageContainer}>
                  ...
                  <p>{formatTime(currentTime)}/{formatTime(audioRef.current?.duration)}</p>
