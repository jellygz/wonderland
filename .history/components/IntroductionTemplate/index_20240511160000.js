...
import Link from "next/link";  // Note: Unused import, consider removing if not used later.
import Restrainer from "@/components/Restrainer";
import { useRouter } from "next/router";  // Note: Unused import, consider removing if not used later.
