    ...
    switch (currentStep) {
      case 0:
        return {
          ...
          icon: <Image src={heartImage} width={65} height={65} alt="quiz Icon" />, 
        };
      case 1:
        return {
          title: "Music Box",
          description: "Relax with our peaceful music box. Inspired by the story Alice in Wonderland.",
          icon: <Image src={musicBoxIcon} width={65} height={65} alt="musicBox Icon" />,
        };
      case 2:
        return {
          title: "Chat Bot",
          description: "Try our real-time chat bot! Don’t feel alone.",
          icon: <Image src={chatBotIcon} width={65} height={65} alt="chatBoat Icon" />,
        };
      default:
        return {};
    }
        ...
        <main className={`${styles.main}`}>
          ...
          <div className={styles.borderContainer}>
            ...
            <button onClick={() => handleClick(router.query.intro)}>
                ...
                <leftArrowIcon className{styles.a}
                </button>
          </div>
