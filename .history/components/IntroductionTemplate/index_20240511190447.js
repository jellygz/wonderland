...
export default function IntroductionTemplate() {
    ...
    }, [currentStep]);  // Added currentStep as a dependency for the useEffect
        ...
        <Restrainer>
            <main className={styles.main}>
                <div className={styles.borderContainer}>
                    ...
                    <button onClick={() => router.push("/main")} className={styles.skipButton}>Skip</button>  // Added className for styling
                </div>
            </main>
        </Restrainer>
    );
