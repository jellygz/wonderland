    ...
    <Restrainer>
      <main className={styles.main}>
        <div className={styles.textContainer}>
          <Image src="/images/top.png" alt="Wonderland Text" width={340} height={370} />
        </div>
        <div className={styles.borderContainer}>
          <Image src="/images/image25.png" alt="Decorative Border" width={400} height={200} />
          <div>
            <button onClick={() => handleArrowClick('left')}>
              <Image src="/images/leftArrowIcon.svg" alt="Left Arrow" width={48} height={48} />
            </button>
            <button onClick={() => handleArrowClick('right')}>
              <Image src="/images/rightArrowIcon.svg" alt="Right Arrow" width={48} height={48} />
            </button>
          </div>
        </div>
