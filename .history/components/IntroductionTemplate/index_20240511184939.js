...
export default function IntroductionTemplate() {
    ...
    const handleSkip = () => {
        navigate('/main'); // Corrected to use navigate
    };
    ...
    return (
        <Restrainer>
            <main className={styles.main}>
                ...
                <button onClick={handleSkip} className={styles.skipButton}>Skip</button>  // Ensure the skip button is styled appropriately
            </main>
        </Restrainer>
    );
}
