...
export default function ChatBot () {
    ...
    useEffect(() => {
        // Load the click sound; ensure the path is correct and accessible
        const audio = new Audio("/music/send_button.mp3");
        setClickSound(audio);
    }, []);
                                ...
                                <div key={index} className={message.sender === "user" ? "user" : "alice"}>
                                    {message.sender === "user" ?
                                        <div className={styles.chat}>
                                            ...
                                            <Image src={userChat} width={48} height={48} alt="User profile" />
                                        </div> :
                                        <div className={styles.chat}>
                                            <Image src={aliceBot} width={48} height={48} alt="Alice bot profile" />
