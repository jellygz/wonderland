...
export default function quiz() {
    ...
    <div>
        <h1>Chapter 1</h1>
        <Image src = {progress1}  alt = {progress1} width={200} height={20} />
        <div className={style.question}>
            <p>You've just followed a hurried rabbit down a rabbit hole. What's your first reaction?</p>
        </div>
        <Image src = {q1} alt = {q1} width={200} height={200} />
        <div>
        <Image src = {leftarrowtri} alt = {leftarrowtri} width={10} height={10} />
        <button className={style.buttonA}>Feel excited and curious about what's below.</button>
        <Image src = {rightarrowtri} alt = {rightarrowtri} width={10} height={10} />
        </div>
        <div>
        <Image src = {leftarrowtri} alt = {q1} width={10} height={10} />
        <button className={style.buttonB}>Worry about how late you're going to be for your next appointment.</button>
        <Image src = {rightarrowtri} width={10} height={10} />
        </div>
    </div>
