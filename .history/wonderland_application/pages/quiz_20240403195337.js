...
export default function Quiz() {
  return (
    <div className={style.container}>
      <h1>Chapter 1</h1>
      <Image src={progress1} alt="Progress" width={430} height={20} layout="responsive" />
      <div className={style.question}>
        <p>You've just followed a hurried rabbit down a rabbit hole. What's your first reaction?</p>
      </div>
      <Image src={q1} alt="Question" width={430} height={200} layout="responsive" />
      <div className={style.navigation}>
        <Image src={leftarrowtri} alt="Left Arrow" width={30} height={30} />
        <button className={style.buttonA}>Feel excited and curious about what's below.</button>
        <Image src={rightarrowtri} alt="Right Arrow" width={30} height={30} />
      </div>
      <div className={style.navigation}>
        <Image src={leftarrowtri} alt="Left Arrow" width={30} height={30} />
