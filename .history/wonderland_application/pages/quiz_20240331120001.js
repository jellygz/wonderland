...
export default function quiz() {
    ...
    <div>
        <h1>Chapter 1</h1>
        <Image src = "../public/images/progress1.svg" width={200} height={20} />
        ...
        <div>
        <Image src = "../public/images/leftarrowtri.svg" width={10} height={}/>
        <button className={style.buttonA}>Feel excited and curious about what's below.</button>
        <Image src = "../public/images/rightarrowtri.svg" width={10} />
        </div>
        <div>
        <Image src = "../public/images/leftarrowtri.svg" width={10} />
